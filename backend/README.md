...
В адресный справочник добавлены административные районы города. Район хранится
у дома и обязателен при его создании. Он возвращается вместе с адресом заявки.
Обязательность задана сразу в миграции `0002`; отдельной `0003` нет.
Демонабор содержит районы для всех домов. Локальная база удалена по решению
пользователя; команды создания и заполнения новой базы приведены ниже.
