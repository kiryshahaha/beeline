...
Добавлен отдельный `seed_demo.py` для заполнения БД демонстрационными данными.
Следующий отдельный коммит — только создание и просмотр одной заявки через HTTP API.
